...
Usage: java -jar markup-blitz.jar [<OPTION>...] [<GRAMMAR>] <INPUT>
  ...
  <OPTION>:
    ...
    --leading-content-policy:<VALUE>    handling of leading unmatched content.
          <VALUE>:
              complete-match    disallow leading unmatched content.
              first-match       skip unmatched content, accept first match.
    --trailing-content-policy:<VALUE>   handling of trailing unmatched content.
          <VALUE>:
              complete-match    disallow trailing unmatched content.
              longest-match     accept longest match, ignore remainder.
              shortest-match    accept shortest match, ignore remainder.
...
- `Map<Option, Object> options`: options for use at generation time and parsing time
...
`Blitz.generate` accepts a map of options and values for influencing generator or parser behavior, or creating additional diagnostic output.
