...
public class RangeSetTest {
  ...
  public void testRangeSet() {
    {
      RangeSet set = RangeSet.of(
        new Range(4, 5),
        new Range(1, 2));
      Assertions.assertEquals("[#1-#2; #4-#5]", set.toString());
      Assertions.assertEquals("[#1-#2; #4-#5]", set.split().toString());
      Assertions.assertEquals("[#1-#2; #4-#5]", set.join().toString());
      Assertions.assertEquals(set.join().toString(), set.join().split().toString());
      Assertions.assertEquals(set.join().toString(), set.split().join().toString());
    }
    {
      RangeSet set = RangeSet.of(
        new Range(1, 2),
    ...
    }
    {
      RangeSet set = RangeSet.of(
        new Range(1, 3),
        new Range(4, 5));
      Assertions.assertEquals("[#1-#3; #4-#5]", set.toString());
      Assertions.assertEquals("[#1-#3; #4-#5]", set.split().toString());
      Assertions.assertEquals("[#1-#5]", set.join().toString());
      Assertions.assertEquals(set.join().toString(), set.join().split().toString());
      Assertions.assertEquals(set.join().toString(), set.split().join().toString());
    }
    {
    ...
    }
    {
      RangeSet set = RangeSet.of(
        new Range(1, 3),
        new Range(3, 5));
      Assertions.assertEquals("[#1-#3; #3-#5]", set.toString());
      Assertions.assertEquals("[#1-#2; #3; #4-#5]", set.split().toString());
      Assertions.assertEquals("[#1-#5]", set.join().toString());
      Assertions.assertEquals(set.join().toString(), set.join().split().toString());
      Assertions.assertEquals(set.join().toString(), set.split().join().toString());
    }
    ...
    }
    {
      RangeSet set = RangeSet.of(
        new Range(1, 2),
        new Range(3, 4));
      Assertions.assertEquals("[#1-#2; #3-#4]", set.toString());
      Assertions.assertEquals("[#1-#2; #3-#4]", set.split().toString());
      Assertions.assertEquals("[#1-#4]", set.join().toString());
      Assertions.assertEquals(set.join().toString(), set.join().split().toString());
      Assertions.assertEquals(set.join().toString(), set.split().join().toString());
    }
    {
    ...
    }
    {
      RangeSet set = RangeSet.of(
        new Range(1, 10),
        new Range(2, 3));
      Assertions.assertEquals("[#1-#a; #2-#3]", set.toString());
      Assertions.assertEquals("[#1; #2-#3; #4-#a]", set.split().toString());
      Assertions.assertEquals("[#1-#a]", set.join().toString());
      Assertions.assertEquals(set.join().toString(), set.join().split().toString());
      Assertions.assertEquals(set.join().toString(), set.split().join().toString());
    }
    {
    ...
    }
    {
      RangeSet set = RangeSet.of(
        ...
        new Range('n', 'q'),
        new Range('p', 't'));
      Assertions.assertEquals("['a'-'z'; 'c'; 'n'-'q'; 'p'-'t']", set.toString());
      Assertions.assertEquals("['a'-'b'; 'c'; 'd'-'m'; 'n'-'o'; 'p'-'q'; 'r'-'t'; 'u'-'z']", set.split().toString());
      Assertions.assertEquals("['a'-'z']", set.join().toString());
      Assertions.assertEquals(set.join().toString(), set.join().split().toString());
      Assertions.assertEquals(set.join().toString(), set.split().join().toString());
    }
    {
  ...
  public void testRandomInsertions() {
    ...
    for (int iteration = 0; iteration < 1000; ++iteration) {
      int numberOfRanges = 1 + random.nextInt(10); // .nextInt(100);
      List<Range> ranges = new ArrayList<>();
      for (int r = 0; r < numberOfRanges; ++r) {
        int f = random.nextInt(10); // 32 + random.nextInt(16384);
        int l = f + random.nextInt(10); // f + random.nextInt(200);
